...
function filterUnfundedOnly() {
    ...
    console.log(listOfNotMetGoalGames);
...
const descriptionMessage = `
    A total of $${totalRaised.toLocaleString('en-US')} have been raised for ${numGames} game${numGames === 1 ? '' : 's'}. 
...
descriptionContainer.innerHTML += `<p>${descriptionMessage}</p>`;
...
console.log('the first game is ' + first.name);
console.log('the second game is ' + second.name);
